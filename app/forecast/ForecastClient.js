...
const IconTarget = () => <svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><circle cx="12" cy="12" r="10"></circle><circle cx="12" cy="12" r="6"></circle><circle cx="12" cy="12" r="2"></circle></svg>;
  ...
  return (
    <>
      ...
      <section className="kpi-grid">
        ...
        <div className="card kpi-card">
          <div className="kpi-icon green"><IconCalendar /></div>
          <div>
        ...
        <div className="card kpi-card">
          ...
          <div>
            ...
            <div className="kpi-sub">Active FG · with sales</div>
          </div>
        </div>
        <div className="card kpi-card">
          <div className="kpi-icon amber"><IconTrophy /></div>
          <div>
        ...
        <div className="barchart">
          {chartData.map((d, i) => (
            <div className="bar-col" key={i}>
              ...
              <div className={"bar" + (d.hist ? "" : d.be ? " be" : " hl")} style={{ height: (d.total / maxBar) * 100 + "%", transition: "all 0.2s ease-in-out" }} />
