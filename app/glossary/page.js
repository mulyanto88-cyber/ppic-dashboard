...
const TERMS = [
  ...
  { group: "Planning & MRP", term: "Daily Schedule (finite-capacity leveling)", tag: "day-by-day", def: "The Daily view spreads each week's production across working days without ever exceeding a line's daily capacity (Mon–Fri 3 shifts, Sat half shift, Sun off, max 5 SKUs per line per day for changeovers). SKUs with the lowest stock cover get the earliest slots. If week 1's requirement doesn't fit, the overflow shifts into week 2 (⚠); if it doesn't fit in two weeks at all it's flagged Unscheduled (⛔) — a signal to add shifts or split across lines.", formula: "daily capacity = weekly capacity ÷ 16.5 × day shifts" },
